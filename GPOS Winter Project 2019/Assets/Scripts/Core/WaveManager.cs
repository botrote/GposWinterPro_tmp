...
public class WaveManager : MonoBehaviour
{
    ...
    {
        factorymanager.PlaceUnit("Building", new Vector2(10, 0), "Soldier", 1, 5f);
        factorymanager.PlaceUnit("Building", new Vector2(-10, 4), "Spearman", 1, 5f);
        factorymanager.PlaceUnit("Building", new Vector2(-10, -4), "Archer", 1, 5f);
    }
}
