...
{
    public static Vector2[] PortalPlace = new Vector2[8]
    {
        new Vector2( -35 , 20),
        new Vector2( 0 , 20),
        new Vector2( 35 , 20),
    ...
    public class subWave
    {
        ...
        public void summon()
        {
            ...
            {
                GameObject.Find("UnitFactory").GetComponent<UnitFactoryManager>().PlaceUnit("Building", PortalPlace[squad.Portal_Number], squad.unitName, squad.unitNumber, 0.1f);
            }
        }
    }
